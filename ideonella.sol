...
contract Ideonella is ERC20 {
    ...
    constructor() ERC20('Ideonella','SAKA'){
        owner=msg.sender;
    ...
    function excludeFromFees(address addressToExclude) onlyOwner public returns (bool) {
        excludedFromFees[addressToExclude]=true;
        return true;
    }
    function checkIfExcluded(address addressToCheck) public view returns (bool){
        if(excludedFromFees[addressToCheck]==true){
            return true;
        }
        else{
            return false;
